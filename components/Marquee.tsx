...
export default function Marquee() {
  ...
  return (
    <div className="space-y-4 overflow-hidden border-b border-white/5 py-5 [mask-image:linear-gradient(90deg,transparent,black_12%,black_88%,transparent)]">
      ...
      <div className="flex w-max animate-marquee-rev gap-10 opacity-50 motion-reduce:animate-none">
        {[...row].reverse().map((capability, i) => (
          <span
            key={i}
            className="flex items-center gap-10 whitespace-nowrap text-sm uppercase tracking-[0.22em] text-dim"
          >
